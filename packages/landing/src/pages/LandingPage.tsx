            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <a href={`${APP_URL}/sign-up`} className="bg-[#FF6100] hover:bg-[#E65700] text-white text-lg font-bold px-10 py-5 rounded-2xl flex items-center justify-center gap-3 transition-all shadow-xl shadow-orange-500/30 group">
                    {t.getStarted}
        ...
        <section className="py-32 bg-white relative overflow-hidden">
          <div className="container mx-auto px-6 text-center space-y-12 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <a href={`${APP_URL}/sign-up`} className="bg-[#FF6100] hover:bg-[#E65700] text-white text-xl font-bold px-12 py-6 rounded-2xl shadow-2xl shadow-orange-500/40 transition-all hover:scale-105 active:scale-95 leading-none flex items-center justify-center">
                {t.getStarted}
              </a>
