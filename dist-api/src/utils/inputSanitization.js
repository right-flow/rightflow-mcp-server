 ...
 */
export function validateFieldNameUniqueness(fields) {
 ...
 */
export function getFieldsWithErrors(fields) {
 ...
 */
export function sanitizeFontSize(size) {
 ...
 */
export function sanitizeCoordinate(coord, max = 10000) {
 ...
 */
export function sanitizeFontWeight(fontWeight) {
    const allowedValues = ['normal', 'bold'];
    if (!fontWeight || !allowedValues.includes(fontWeight)) {
        return 'normal';
    }
    return fontWeight;
}
 ...
 */
export function sanitizeFontStyle(fontStyle) {
    const allowedValues = ['normal', 'italic'];
    if (!fontStyle || !allowedValues.includes(fontStyle)) {
        return 'normal';
    }
    return fontStyle;
}
 ...
 */
export function sanitizeTextAlign(textAlign, defaultAlign = 'left') {
    const allowedValues = ['left', 'center', 'right'];
    if (!textAlign || !allowedValues.includes(textAlign)) {
        return defaultAlign;
    }
    return textAlign;
}
