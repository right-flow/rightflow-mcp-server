 ...
 */
export function generateFilename(namingSettings, fallbackFilename = 'document') {
    ...
    if (filename.length > MAX_FILENAME_LENGTH) {
        console.warn(`Filename too long (${filename.length} chars), truncating to ${MAX_FILENAME_LENGTH}`);
 ...
 */
export function previewFilename(namingSettings) {
    if (!namingSettings.filenameTemplate || namingSettings.filenameTemplate.length === 0) {
