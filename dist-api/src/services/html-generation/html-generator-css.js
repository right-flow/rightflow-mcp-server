 ...
 */
export function generateDocsFlowCSS(rtl, theme) {
 ...
 */
export function generateFormJS(formId, rtl, totalFormPages = 1, includeWelcome = true, userRole = 'client') {
    const navigationJs = generateNavigationJs(formId, rtl, totalFormPages, includeWelcome, userRole);
...
//# sourceMappingURL=html-generator-css.js.map