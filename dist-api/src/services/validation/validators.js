 ...
 */
export function validateDigitsOnly(value) {
    if (value === '')
 ...
 */
export function validateLengthMin(value, params) {
    if (value === '')
        return true;
 ...
 */
export function validateLengthBetween(value, params) {
    if (value === '')
        return true;
 ...
 */
export function validateLengthExact(value, params) {
    if (value === '')
        return true;
 ...
 */
export function validateRegex(value, params) {
    if (value === '')
        return true;
    try {
 ...
 */
export function validateGreaterThan(value, params) {
    if (value === '')
        return true;
 ...
 */
export function validateRange(value, params) {
    if (value === '')
        return true;
    const num = parseFloat(value);
    if (isNaN(num))
 ...
 */
export function padIdTo9(_value) {
 ...
 */
export function validateAge(value, params) {
    if (value === '')
        return true;
 ...
 */
export function validateNotInFuture(value) {
    if (value === '')
        return true;
    const date = new Date(value);
 ...
 */
export function validateInList(value, params) {
    if (value === '')
        return true;
    // Predefined lists
    const lists = {
 ...
 */
export function validateRequiredChecked(_value, _params, element) {
 ...
 */
export function validateMobileIL(value) {
    if (value === '')
        return true;
...
export const validators = {
    ...
    length_min: validateLengthMin,
    length_between: validateLengthBetween,
    length_exact: validateLengthExact,
    regex: validateRegex,
 ...
 */
export function runValidator(validatorName, value, params, element) {
